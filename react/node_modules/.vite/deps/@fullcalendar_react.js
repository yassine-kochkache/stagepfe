...
var FullCalendar = class extends import_react.Component {
  ...
  componentDidMount() {
    ...
    customRenderingStore.subscribe((customRenderingMap) => {
      ...
      const runFunc = syncRenderingByDefault || isMounting || this.isUpdating || this.isUnmounting || requestTimestamp - lastRequestTimestamp < 100 ? runNow : import_react_dom.flushSync;
      runFunc(() => {
