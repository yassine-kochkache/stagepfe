  ...
  workerFactory.createWorker(self, {
    ...
    encode: function encode(_ref) {
      ...
      if (timeslice !== null) {
        ...
        var shiftedChannelDataArrays = shiftChannelDataArrays(recording.channelDataArrays, Math.ceil(timeslice * (recording.sampleRate / 1e3)));
    ...
    record: function record(_ref2) {
      ...
      if (encoding !== void 0 && computeNumberOfSamples(recording.channelDataArrays[0]) * (1e3 / sampleRate) >= encoding.timeslice) {
        var shiftedChannelDataArrays = shiftChannelDataArrays(recording.channelDataArrays, Math.ceil(encoding.timeslice * (sampleRate / 1e3)));
